    ...
    <>
      <div className="font-manrope flex flex-col items-center gap-10 text-white mt-5 mb-[5rem] mobile:mb-[10rem]">
        <section className="flex flex-col px-[2rem] sm:px-[5rem] md:px-[10rem] px-[15rem]">
          ...
          <p>
            Welcome to Slove.ai. These terms and conditions govern your use of
            our website. By using our website and app, you agree to be bound by
        ...
        <section className="flex flex-col px-[2rem] sm:px-[5rem] md:px-[10rem] px-[15rem]">
          ...
          <p>
            ...
            graphics, logos, images, audio clips, and software, is owned or
            licensed by us and is protected by copyright, trademark, and other
            intellectual property laws. You may not use any content on our
