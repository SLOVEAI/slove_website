  ...
  return (
    <div className="mx-auto">
      <div className="relative group">
        ...
        <div className="relative px-[3rem] md:px-[5rem] pt-6 bg-[#1A1A1A] ring-1 ring-gray-900/5 rounded-3xl leading-none flex items-top justify-start space-x-6">
          <div className="whitespace-wrap flex flex-col h-auto md:h-[41rem] w-[16rem] sm:w-[18rem] md:w-[22rem] items-center pt-5 gap-5 overflow-hidden">
            <h1 className="text-white text-[2rem] font-clashDisplay whitespace-wrap">
              {props.label}
            </h1>
