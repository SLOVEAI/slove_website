...
function Footer() {
  return (
    <>
      <footer className="flex flex-col gap-10 pt-[5rem] mt-[5rem] md:mt-0 mb-[3rem] px-[7rem]">
        <div className="flex flex-col gap-[4rem] md:gap-0 md:flex-row justify-center sm:justify-between items-center">
          <div>
        ...
        <p className="ml-5 text-gray-400 self-center text-sm">
          2023 BISASI AB. All rights reserved.
        </p>
      </footer>
    </>
  );
